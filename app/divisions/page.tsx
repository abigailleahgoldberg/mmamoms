...
Zhang Weili currently sits at the top as the most complete fighter at the weight, combining striking power with legitimate wrestling in a package that the division has found no reliable answer for. The challenger pool is the deepest it has ever been, with Tatiana Suarez's undefeated wrestling résumé, Yan Xiaonan's relentless pressure, and several young contenders pushing toward the title conversation.

The strawweight division was born in The Ultimate Fighter 20, a tournament that produced Carla Esparza as the first champion and Rose Namajunas as a memorable finalist. The division grew rapidly from there into one of the most prestigious and competitive in the UFC.`,
  ...
  },
  {
    ...
    topContenders: [
      { name: 'Manon Fiorot', rank: 1, record: '13-1', note: 'Former kickboxer, elite technical striker' },
      { name: 'Valentina Shevchenko', rank: 2, record: '24-5', note: 'Former 7-time champion, still elite' },
      { name: 'Alexa Grasso', rank: 3, record: '16-3', note: 'Former champion, dangerous submission game' },
...
The flyweight division was controversial when created because it was difficult to fill the roster with enough competitive fighters. That problem has been largely solved by the global expansion of women's MMA and the development of fighters through Invicta and international promotions.`,
  ...
  },
  {
    ...
    topContenders: [
      ...
      { name: 'Norma Dumont', rank: 4, record: '8-2', note: 'Technical striker with championship aspirations' },
...
Julianna Pena is the current champion after an up-and-down ride with Amanda Nunes that included the biggest upset in women's MMA history and a rematch where Nunes demonstrated what she was capable of when fully prepared. The division now has depth it lacked in the Nunes era — multiple serious contenders, the arrival of Kayla Harrison from the PFL, and the continued presence of foundational figures like Holly Holm.

The bantamweight division has produced more women's MMA Hall of Famers than any other division and has the richest individual history in the sport. Every significant era of women's MMA maps to a bantamweight storyline.`,
  ...
  },
  {
    ...
    description: `The women's featherweight division at 145 pounds has been one of the more troubled weights in UFC history. The problem is roster depth — there are simply not enough elite women who compete at 145 pounds to sustain a healthy division with regular activity. The weight is too heavy for most bantamweights who move up and too light for many fighters who compete at heavier weights elsewhere.

Cris Cyborg was the UFC featherweight champion from 2017 to 2018, and her reign at the weight is the most significant thing the division has ever produced. When Amanda Nunes stopped her in 51 seconds at UFC 232, the championship picture at featherweight essentially collapsed. The division has been functionally inactive in the UFC since, with the UFC rarely scheduling title fights and the roster remaining thin.

Cyborg has been competing in the PFL since 2021 and continues to be the most prominent 145-pound women's fighter in the world outside the UFC. Whether the division ever becomes truly active in the UFC depends on whether enough elite women can be developed or signed at the weight.`,
      ...
      <section style={{
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <h1 style={{
            ...
            <span style={{ display: 'block', color: COLORS.pink }}>CLASSES.</span>
          </h1>
          <p style={{
            ...
            Four women&apos;s divisions. Three active and one barely breathing. Champions, contenders, and the story behind each weight class — no fluff, just the breakdown.
          </p>
            ...
            {divisions.map(d => (
              <a
                ...
                style={{
                  ...
                  letterSpacing: '2px',
                  textTransform: 'uppercase',
                  color: d.active ? COLORS.bone : COLORS.silver,
                  padding: '0.6rem 1.25rem',
                  border: `2px solid ${d.active ? 'rgba(255,45,120,0.5)' : 'rgba(192,192,200,0.3)'}`,
                  textDecoration: 'none',
          ...
          >
            ...
            <div style={{
              ...
              <div style={{
                ...
                background: division.active ? `rgba(255,45,120,0.12)` : 'rgba(192,192,200,0.08)',
                border: `2px solid ${division.active ? 'rgba(255,45,120,0.5)' : 'rgba(192,192,200,0.3)'}`,
                display: 'flex',
                ...
                <div style={{
                  ...
                  fontWeight: 800,
                  fontSize: '1.8rem',
                  color: division.active ? COLORS.pink : COLORS.silver,
                  lineHeight: 1,
                  letterSpacing: '-1px',
                }}>
                  {division.poundage}
            ...
            <div style={{
              display: 'grid',
              gridTemplateColumns: division.active ? '1fr 300px' : '1fr',
              gap: '3rem',
              alignItems: 'start',
            }}>
              {/* Left — description + contenders */}
              <div>
                {/* Description */}
                    ...
                    {division.topContenders.map((c) => (
                      <div
                        ...
                        style={{
                          ...
                          borderLeft: `3px solid rgba(255,45,120,0.3)`,
                        }}
                      >
                        <div style={{
                          fontFamily: "'Space Mono', monospace",
